...
const apiRenderConfig: ApiRenderConfigType = {
    openCache: true,
    ...
    defaultTreeLabelKey: 'label',
    defaultTreeValueKey: 'value',
    defaultTreeIdKey: 'id',
    defaultTreeChildrenKey: 'children',
    defaultTreeParentIdKey: 'parentId',
    defaultOptionsValueKey: 'value',
    defaultOptionsLabelKey: 'label',
}
...
export function getApiRenderConfig() {
    return Object.assign({}, apiRenderConfig)
}
